...
- SMB (Server Message Block): Port (139+445) (TCP)
...
>[!Note]
>SMB is file share protocol .. and last exploit is wannacry virus (eternal-blue,ms17010) which utilize SMB exploit to navigate through network . it was vicious quickly since smb port  often is open in networks
